    ...
    (val dao: MarvelDAO) :LocalRepository
{
    ...
    override fun insertHero(marvelRoom: MarvelRoom): WrapperResponse<Long> = runBlocking(Dispatchers.IO){
        val response = try{
    ...
    override fun removeHero(heroToRemove: String): WrapperResponse<Int> = runBlocking(Dispatchers.IO){
        val response = try{
    ...
    override fun selectLocalHeros(): WrapperResponse<List<RoomResponse>> = runBlocking(Dispatchers.IO){
